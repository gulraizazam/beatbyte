...
(function($) {
	...
	function uT() {
		h.upt = setInterval(function() {
			...
			if(h.c.vr.value == 0){
				h.c.vF.setAttribute("class","fa fa fa-volume-off");
			}else if(h.c.vr.value <= 50){
				h.c.vF.setAttribute("class","fa fa-volume-down");
			}else if(h.c.vr.value >= 50){
				h.c.vF.setAttribute("class","fa fa-volume-up");
			}
			}
		}, 100);
	}
	...
	var pL = function() {
			if(h.c.a.duration > 0){
			if(this.children[0].getAttribute("class") == "fa fa-play"){
				h.c.a.play();
				this.setAttribute("class", "pause");
				this.children[0].setAttribute("class", "fa fa-pause");
				uT();
			}else if(this.children[0].getAttribute("class") == "fa fa-pause"){
				h.c.a.pause();
				this.setAttribute("class", "play");
				this.children[0].setAttribute("class", "fa fa-play");
				clearInterval(h.upt);
			}
			}
	}
	...
	function rpa() {
			h.c.ply.children[0].setAttribute("class", "fa fa-play");
