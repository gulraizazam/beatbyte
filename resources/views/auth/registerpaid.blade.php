      ...
      <div class="wizard-form">
        ...
        <div class="wizard-header">
          ...
          <p>Fill Out These Fields To Create Account.</p>
            ...
            <form class="form-register" action="{{route('packege.payment',$packege->id)}}" method="post" id="registerform">
              @csrf
              <input type="hidden" name="pkgprice" value="{{$packege->packege_price}}">
              <div id="form-total">
                <!-- SECTION 1 -->
                  <h2>1</h2>
                  <section>
