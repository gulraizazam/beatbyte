    		...
    		<div class="sub-menu-wrapper hidden-sm hidden-xs">
		        ...
		        <div class="sub-menu hidden-sm hidden-xs">
		            ...
		            <div class="sub-menu__item ">
		                ...
		                <a class="sub-menu__link" href="#"><i class="fa fa-list"></i> All Genre</a>
		            ...
		            <div class="sub-menu__item active">
		                ...
		                <a class="sub-menu__link" href="{{route('mood.add')}}"><i class="fa fa-upload"></i> Add Genre</a>
      	...
      	<div class="container">
      		...
      		<div class="row">
				...
				<div class="col-md-12" style="padding-bottom: 20px;border: 3px solid #cfdbe2;">
					...
					<form action="{{route('generations.store')}}" method="POST" enctype="multipart/form-data" onsubmit="LoadForm()">
						...
						<div class="row">
							...
							<div class="form-group col-md-6">
					            ...
					            <input class="form-control" type="text" name="generationname"  placeholder="Genre">
