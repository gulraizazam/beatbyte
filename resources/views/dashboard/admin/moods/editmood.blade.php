      	...
      	<div class="container">
      		...
      		<div class="row">
				...
				<div class="col-md-12" style="padding-bottom: 20px;border: 3px solid #cfdbe2;">
					...
					<form action="{{route('mood.update',$editmood->id)}}" method="POST" enctype="multipart/form-data"  onsubmit="LoadForm()">
						...
						<div class="row">
							...
							<div class="form-group col-md-6">
					            ...
					            <input class="form-control" type="text" name="moodname"  placeholder="File Name" value="{{$editmood->mood_name}}">
				     	 ...
				     	 <button class="btn btn-primary" type="submit">Update Mood</button>
