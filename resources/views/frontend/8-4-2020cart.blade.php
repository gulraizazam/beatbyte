                                            ...
                                            <div class="top_songs_list_left">
                                                <div class="treanding_slider_main_box top_lis_left_content">
                                                    ...
                                                    <div class="top_songs_list0img">
                                                        <img src="{{URL::to('storage/app/uploads/images/')}}/{{$item->attributes->image}}" class="circle d-none d-sm-block"
                                                            alt="img" style="height: 100px;width: 100%;">
                                                    </div>
                                                    @else
                                                    <div class="top_songs_list0img">
                                                        <img src="{{asset('images/placeholder@100x.jpg')}}" class="circle d-none d-sm-block"
                                                            alt="img" style="height: 100px;width: 100%;">
                                                    </div>
                                                    @endif
                                ...
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="top_list_tract_view display-space-between">
                                        <div class="treanding_slider_main_box top_lis_left_content">
                                        	@if($item->attributes->image)
                                            <div class="top_songs_list0img">
                                                <img src="{{URL::to('storage/app/uploads/images/')}}/{{$item->attributes->image}}" class="circle d-none d-sm-block" alt="img" style="height: 100px;width: 100%;">
                                            </div>
                                            @else
                                            <div class="top_songs_list0img">
                                                <img src="{{asset('images/placeholder@100x.jpg')}}" class="circle d-none d-sm-block" alt="img" style="height: 100px;width: 100%;">
                                            </div>
                                            @endif
                                            <div class="release_content_artist top_list_content_artist">
