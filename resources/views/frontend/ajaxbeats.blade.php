        ...
        <div class="top_songs_list free_music_wrapper m24_cover">
            ...
            <div class="top_songs_list_right">
                <div class="top_list_tract_view">
                    ...
                    <a href="{{url('downloadfreebeat',$beat->id)}}" id="addToCart" class=" button button-purpleX btn-primary btn"><i class="flaticon-download" style="margin-right: 5px;"></i> Free
                                                        
                                                    </a>
                    @else
                     <a href="{{route('cart.add',$beat->id)}}" id="addToCart" class="button button-purpleX btn-primary btn"><i class="fas fa-shopping-cart"></i>
                        $ {{$beat->basic_price}}
                    </a>
                    @endif
