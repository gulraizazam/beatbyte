                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <div class="navi_searchbar_wrapper">
                                                <i class="flaticon-magnifying-glass" onclick="GetSearchData()"></i>
                                                <input type="text" id="justAnotherInputBox" placeholder="Sort By" name="search" style="color: white" />
                                            </div>
                                        </div>
                                                ...
                                                <div class="owl-carousel owl-theme">
                                                    ...
                                                    <div class="item">
                                                        <div class="treanding_slider_main_box m24_cover">
                                                            @if($beat->album_image)
                                                            <a href="{{url('album',$beat->id)}}"><img src="{{URL::to('storage/app/uploads/images')}}/{{ $beat->album_image}}" alt="img" style="height: 180px"></a>
                                                            @else
                                                            ...
                                                            <div class="various_song_playlist">
                                                                ...
                                                                <p><a href="{{url('album',$beat->id)}}" class="playbeat" style="color: white">{{$beat->album_name}}</a></p>
                                            ...
                                            <div class="top_songs_list_left">
                                                <div class="treanding_slider_main_box top_lis_left_content">
                                                    ...
                                                    <div class="release_content_artist top_list_content_artist">
                                                        <p><a href="javaScript:;" onclick="PlayAudio('{{$song->song_file}}','{{$song->songname}}')" class="songname">{{$song->songname}}</a></p>
...
function PlaySong(source){
    ...
    var myPlalist = new adonisJPlayerPlaylist({
        jPlayer: "#adonis_jplayer_main",
        cssSelectorAncestor: "#adonis_jp_container"
    }); 
     myPlalist.play(source);
...
{
    var searchitem = $('#justAnotherInputBox').val();
