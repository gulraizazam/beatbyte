...
<!-- top navi wrapper Start -->
    <div class="m24_main_wrapper">
        ...
        <div class="section-all  album_inner_list auti m24_cover">
            <div class="row">
                <div class="col-md-12"><h1 class="text-center">{{$getplaylistdetail->playlist_name}}</h1>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <img src="{{asset('images/beat.jpg')}}" class="d-none d-sm-block" alt="img" style="height: 200px;width: 80%;border-radius: 10px;margin: 0px auto;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <?php
                                         $allcomments = \App\Comment::join('users','users.id','=','comments.userid')->where('albumid',$getplaylistdetail->id)->where('comments.is_approved',1)->get();
                                        
                                        ?>
                                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                            <form action="{{route('comment.add')}}" method="post">
                                               @csrf
                                                <input type="hidden" name="albumid" value="{{$getplaylistdetail->id}}">
