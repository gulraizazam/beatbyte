            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                                ...
                                <div class="lang_apply_btn">
                                    ...
                                    <ul>
                                        ...
                                        <li data-animation="animated fadeInUp">
                                            @if(Auth::guest())
                                            <a href="{{url('login')}}"><i class="flaticon-play-button"></i>Upload Your Beats</a>
                                            @else
                                            <a href="{{route('seller.index')}}"><i class="flaticon-play-button"></i>Upload Your Beats</a>
                                            @endif
                                        </li>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 text-right">
                        ...
                        <img src="{{asset('images/main-image.png')}}" class="img-fluid mt-5" alt="img">
                    ...
                    <div id="menu1" class="tab-pane active">
                        ...
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 p-4">
                                ...
                                <img src="{{asset('images/music-player.png')}}" class="img-fluid" alt="img">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 px-5 text-left">
                                ...
                                <div class="buttons">
                                    ...
                                    <a href="{{route('user.signup')}}" class="btn btn-danger mr-3">Start Selling</a>


                                    <a href="{{url('beats')}}" class="btn btn-outline">BROWSE BEATS</a>
            ...
            <div class="container-fluid mt-5">
                ...
                <div class="row mb-4 pb-5 pt-3">
                    ...
                    <div class="col-md-4 m-auto">
                        ...
                        <div class="buttons text-center">
                            ...
                            <a href="{{route('user.signup')}}" class="btn btn-white mr-3">START SELLING</a>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-8 m-auto">
                        ...
                        <img src="{{asset('images/macbook-2.png')}}" class="img-fluid img-h-600" alt="Beat Byte">
