...
Route::get('addcartbeat/{id}','FrontendController@AddToCartBeat')->name('cart.addbeat');
...
Route::group(['middleware' => 'seller'], function () {
	...
	// my account
	Route::get('selleraccount/{id}','SellerController@MyAccount')->name('seller.profile');
	...
	Route::get('upgrade/{id}','PaymentController@UpgradePackege');
